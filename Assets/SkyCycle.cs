...
public class SkyCycle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sunTilt.eulerAngles = new Vector3 (Mathf.Clamp(latitudeAngle, 0, 90), sunTilt.eulerAngles.y); //set the sun tilt
    ...
    void UpdateSky()
    {
        ...
        sunOrbit.localEulerAngles = new Vector3(sunTilt.eulerAngles.x, smoothMin / 4);
    ...
    /*void digitalDisplay(string num)
